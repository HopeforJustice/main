...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?> style="margin-bottom:0;">
    <header class="entry-header" style="margin-bottom: 0;">
        <h2 style="font-size: var(--wp--preset--font-size--default); font-weight:bold; margin-bottom:0;"><a href="<?php echo esc_url(get_permalink()) ?>" rel="bookmark"><?php echo strip_tags(get_the_title()) ?></a></h2>
    </header><!-- .entry-header -->
