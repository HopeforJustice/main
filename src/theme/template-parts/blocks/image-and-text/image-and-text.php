...
<div id="<?php esc_attr($id); ?>" class="image-text <?php if ($flip) {
	echo "image-text--flipped";
} ?> <?php if ($background_color) {
 	echo "image-text--has-background";
 } ?>" style=" <?php echo "background-color:" . $background_color . "; color:" . $color; ?>">
    <div class="better-grid">
        <div <?php if (
        	$video
        ) { ?> data-toggle="modal" data-target="#video-modal" data-src="<?php echo $video; ?>" <?php } ?> class="image-text__image-container <?php if (
 	$video
 ) {
 	echo "video-trigger";
 } ?>" style="--span: <?php echo $image_span; ?>">
