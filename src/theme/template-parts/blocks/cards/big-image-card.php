    ...
    <div class="big-image-card" style="background:<?php echo $gradient_a; ?>">
        ...
        <div class="big-image-card__content">
            ...
            <<?php if ($title_size == "big-image-card__title--large") {
            	...
            	echo $title_size;
            } ?> style="margin-bottom:<?php echo $title_margin_bottom; ?>" class="<?php if (
	$title_size == "big-image-card__title--large"
) {
	echo $title_size;
} ?> big-image-card__title block-title <?php echo $title_font; ?>">
                <?php echo $title; ?>
            </<?php if ($title_size == "big-image-card__title--large") {
            	echo "h1";
            } else {
