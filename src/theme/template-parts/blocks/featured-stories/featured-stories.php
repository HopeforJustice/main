...
<div class="better-grid featured-stories">
    ...
    <?php if ($featured_stories): ?>
        <?php while (have_rows("featured_stories")):
        	the_row(); ?>
            <?php
            ...
            <div class="featured-stories__story">
                ...
                <a <?php if (!is_admin()) {
                	echo 'href="' . $link . '"';
                } ?> class="featured-stories__link"></a>
                <div class="featured-stories__img" style="background-image: url('<?php echo $image_src; ?>'); background-position: <?php echo $image[
	"left"
] .
	"% " .
	$image["top"]; ?>%;"></div>
                ...
                <div class="featured-stories__content">
                            ...
                            foreach ($tags as $tag) {
                            	if ($count < 2) {
                            		$tag_link = get_tag_link(
                            			$tag->term_id
                            		); ?><a class="featured-stories__tag" href="<?php echo $tag_link; ?>"><?php echo $tag->name; ?></a>
                            <?php $count++;
                            	}
                            }
                            ?>
                    ...
                    <div class="featured-stories__title">
                        <b><?php echo $alt_title
                        	? $alt_title
                        	: $title; ?><span style="white-space: pre;">&nbsp;<img alt="arrow" src="<?php echo get_template_directory_uri() .
