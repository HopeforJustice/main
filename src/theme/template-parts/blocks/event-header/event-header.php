    ...
    <div class="better-grid">
        ...
        <div class="event-header__info">
            ...
            <div class="event-header__time">
                <img class="event-header__clock" src="<?php echo get_template_directory_uri() .
            ...
            <div class="event-header__location">
                <?php if ($event_type == "online") { ?>
                    <img class="event-header__globe" src="<?php echo get_template_directory_uri() .
                    	"/assets/img/globe.svg"; ?>">
                    <p>
                        <?php echo $event_location; ?>
                    </p>
                <?php } else { ?>
                    <img class="event-header__balloon" src="<?php echo get_template_directory_uri() .
