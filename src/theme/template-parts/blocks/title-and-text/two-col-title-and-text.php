...
<div id="<?php echo esc_attr(
	$id
); ?>" class="better-grid two-col-title-and-text hfj-block <?php if ($indent) {
	echo "two-col-title-and-text--indent";
} ?>" style="--margin-bottom-mobile:<?php echo $block_margin_bottom_mobile; ?>; --margin-bottom-desktop: <?php echo $block_margin_bottom_desktop; ?>;">

    <?php while (have_rows("cols")):
