<?php
$venmo_link = get_field("venmo_link") ?: "#";
$other_link = get_field("other_link") ?: "#";
?>

<div class="pre-donation">
    <div class="pre-donation__logos">
        <div class="pre-donation__hfj">
        <a id="logo-pre-donation" style="margin-bottom: -5px" href="/">
        ...
        <div class="pre-donation__partner">
        <img alt="facebook link" src="<?php echo get_template_directory_uri() .
        	"/assets/img/The-Belonging-Co-Logo-2019-MASTER-Black.png"; ?>">
        </div>
    </div>
    <div class="pre-donation__body">
        <p>Choose a way to donate
        to Hope&nbsp;for&nbsp;Justice</p>
        <div class="pre-donation__line"></div>
        <a href="<?php echo $venmo_link; ?>" class="pre-donation__venmo pre-donation__button">
            <img src="<?php echo get_template_directory_uri() .
            	"/assets/img/Venmo_Logo_White.png"; ?>" alt="">
        </a>
        <a href="<?php echo $other_link; ?>"class="pre-donation__paypal pre-donation__button">
            <img src="<?php echo get_template_directory_uri() .
            	"/assets/img/pp-logo-150px.png"; ?>" alt="">
        </a>
        <a href="<?php echo $other_link; ?>" class="pre-donation__card pre-donation__button">
            <span>Donate with card details</span>
            <img src="<?php echo get_template_directory_uri() .
            	"/assets/img/GPay_Acceptance_Mark_800.png"; ?>" alt="">
            <img src="<?php echo get_template_directory_uri() .
            	"/assets/img/Apple_Pay_Mark_RGB_041619.svg"; ?>" alt="">
        </a>
    </div>
</div>
