...
<div class="better-grid hfj-block block-button <?php echo $align; ?>">
    ...
    <div class="block-button__inner <?php if ($indent) {
    	echo "block-button__inner--indent";
    } ?>">
        <a <?php if (
        	$video_link_a ||
        	$modal_name_a
        ) { ?> data-toggle="modal" data-target="<?php if ($modal_name_a) {
 	echo "#" . $modal_name_a;
 } else {
 	echo "#video-modal";
	...
	$button_style_a == "plain"
) { ?>button--plain__text<?php } ?>"><?php echo $link_title_a; ?></span><?php if (
	$button_style_a == "plain"
) { ?><span style="white-space: pre;" class="block-card__arrow">&nbsp;<img alt="arrow" src="<?php echo get_template_directory_uri() .
	"/assets/img/link-arrow.svg"; ?>"></span><?php } ?>
        </a>
        ...
        <?php if ($link_b) { ?>
            <a <?php if (
            	$video_link_b ||
            	$modal_name_b
            ) { ?> data-toggle="modal" data-target="<?php if ($modal_name_b) {
 	echo "#" . $modal_name_b;
 } else {
 	echo "#video-modal";
	...
	$button_style_b == "plain"
) { ?>button--plain__text<?php } ?>"><?php echo $link_title_b; ?></span><?php if (
	$button_style_b == "plain"
) { ?><span style="white-space: pre;" class="block-card__arrow">&nbsp;<img alt="arrow" src="<?php echo get_template_directory_uri() .
	"/assets/img/link-arrow.svg"; ?>"></span><?php } ?>
            </a>
