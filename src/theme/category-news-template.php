...
<div class="container news-page" id="news-page">
	...
	<div class="row align-items-center">
		...
		<div class="col-md-6 col-sm-12 col-news">
			...
			<!-- Contact press -->
			<p class="text-right contact-press">
				<span>Contact Press:</span>press@hopeforjustice.org
			</p>
						...
						<img src="<?php echo get_the_post_thumbnail_url(); ?>" class="img-fluid">
					  	<div class="card-body">
					    	<div class="card-text">
								...
								<h3>
									<span href="javascript:void(0)" class="no-links">
										<?php the_title(); ?>		
									</span>
								</h3>
					    		<p class="text-para">
					...
					<div class="card" >
						<div class="card-body">
							<div class="card-text"> 
								...
								<h3>
									<a href="javascript:void(0)" class="no-links">
										<?php the_title(); ?>
									</a>
								</h3>
								<p class="text-para">
