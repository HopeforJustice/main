...
<main id="main" class="site-main" role="main">
	...
	<div class="grid">
		...
		<div class="layout-center get-involved__more-button">
			<a href="<?php the_field('grid_more_button_link'); ?>" class="button button--grey">
				<div class="button__text bold">
		...
		-->
		<div class="accordion">
			<h2 class="accordion__title font-fk font-fk--no-transform">
				<?php the_field('drag_cards_title'); ?>
			</h2>
			
			<div class="accordion__section">
				<h3 class="accordion__section-title font-canela">
					<?php the_field('card_1_title'); ?>
				</h3>
				<div class="accordion__plus accordion__plus--open"><img src="<?php echo get_template_directory_uri().'/assets/img/cross.svg'; ?>" alt=""></div>
				<div class="accordion__line"></div>
				<div class="accordion__content accordion__content--open">
					<p><?php the_field('card_1_text'); ?></p>
				</div>
			</div>
			...
			<div class="accordion__section">
				...
				<div class="accordion__plus accordion__plus"><img src="<?php echo get_template_directory_uri().'/assets/img/cross.svg'; ?>" alt=""></div>
				<div class="accordion__line"></div>
				<div class="accordion__content accordion__content">
					<p><?php the_field('card_2_text'); ?></p>
				</div>
			</div>
