				...
				<div class="block-post__header-content">
					...
					<div class="block-post__breadcrumbs">
						...
						?>
							...
							<span style="white-space: nowrap; overflow:hidden; text-overflow: ellipsis;" class="aioseo-breadcrumb">
								<div style="white-space: nowrap; overflow:hidden; text-overflow: ellipsis;"><?php the_title() ?></div>
							</span>
		...
		<div class="block-post__author-share">
			<div class="better-grid">
				<div class="block-post__author-share-content">
					<div class="block-post__share block-post__share--left">
						<p>Share:</p>
						<!-- social icons -->
