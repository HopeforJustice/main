            ...
            if ($page != $url) {
                if (get_field('push_banner_text', 'option')) { ?>
                    <?php if (!isset($_COOKIE[$cookie_name])) { ?>
                        <div id="pushBanner" data-cookie="wordpress_<?php echo the_field('push_banner_cookie', 'option'); ?>" style="background-color: <?php echo the_field('push_banner_background', 'option'); ?>;" class="push-banner"><a style="color: <?php echo the_field('push_banner_color', 'option'); ?>;" href="<?php echo the_field('push_banner_link', 'option'); ?>"><?php echo the_field('push_banner_text', 'option'); ?></a>
                        </div>
                    <?php }  ?>
                <?php }  ?>
            <?php }  ?>
                    ...
                    <svg aria-labelledby="logoSVGTitle" class="header__logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 173.806 52.08">
                        ...
                        <g id="Group_6902" data-name="Group 6902" transform="translate(-131.194 -13.459)">
                            <g id="Group_4" data-name="Group 4" transform="translate(184.492 30.51)">
                                <path id="Path_32" data-name="Path 32" d="M344.869,566.7v7.213h-1.421V566.7h-3.17v17.487h3.17v-7.432h1.421v7.432h3.17V566.7Z" transform="translate(-340.278 -566.429)" fill="<?php echo $args['icons'] == 'white' ? '#ffffff' : '#212322' ?>" />
                                <path id="Path_20" data-name="Path 20" d="M387.724,573.842c0-6.011,1.64-8.306,4.482-8.306s4.482,2.295,4.482,8.306v1.311c0,6.011-1.639,8.306-4.482,8.306s-4.482-2.295-4.482-8.306Zm3.608,5.77c0,.721.35,1.115.874,1.115s.875-.393.875-1.115V569.274c0-.722-.35-1.115-.875-1.115s-.874.393-.874,1.115Z" transform="translate(-378.83 -565.482)" fill="<?php echo $args['icons'] == 'white' ? '#ffffff' : '#212322' ?>" />
                                <path id="Path_21" data-name="Path 21" d="M444.819,566.7c2.667,0,4.962,1.749,4.962,5.464v.438c0,3.716-2.3,5.464-4.919,5.464v6.121h-3.279V566.7Zm.044,8.743h.219c.874,0,1.421-.5,1.421-1.748v-2.623c0-1.246-.547-1.748-1.421-1.748h-.219Z" transform="translate(-422.59 -566.427)" fill="<?php echo $args['icons'] == 'white' ? '#ffffff' : '#212322' ?>" />
                                <path id="Path_22" data-name="Path 22" d="M495.519,566.7v2.842H492.9v4.371h2.3v2.842h-2.3v4.59h2.624v2.842h-5.9V566.7Z" transform="translate(-461.62 -566.426)" fill="<?php echo $args['icons'] == 'white' ? '#ffffff' : '#212322' ?>" />
                                <path id="Path_23" data-name="Path 23" d="M548.064,566.41h5.9v2.841h-2.624v4.372h2.186v2.842h-2.186V583.9h-3.279Z" transform="translate(-509.109 -566.189)" fill="<?php echo $args['icons'] == 'white' ? '#ffffff' : '#212322' ?>" />
                                <path id="Path_24" data-name="Path 24" d="M581.524,573.55c0-6.011,1.64-8.306,4.482-8.306s4.482,2.295,4.482,8.306v1.311c0,6.011-1.64,8.306-4.482,8.306s-4.482-2.295-4.482-8.306Zm3.608,5.77c0,.721.35,1.115.874,1.115s.875-.393.875-1.115V568.982c0-.722-.349-1.115-.875-1.115s-.874.393-.874,1.115Z" transform="translate(-536.297 -565.244)" fill="<?php echo $args['icons'] == 'white' ? '#ffffff' : '#212322' ?>" />
                                <path id="Path_25" data-name="Path 25" d="M638.1,566.411c2.755,0,4.854,1.924,4.854,5.311a5.734,5.734,0,0,1-1.858,4.59l1.64,7.367v.218h-3.17l-1.246-6.645h-.328l.153,6.645h-3.279V566.411Zm.044,8.525h.109c.766,0,1.422-.591,1.422-1.749v-2.4c0-1.158-.656-1.748-1.422-1.748h-.109Z" transform="translate(-579.64 -566.192)" fill="<?php echo $args['icons'] == 'white' ? '#ffffff' : '#212322' ?>" />
                                <path id="Path_26" data-name="Path 26" d="M707.844,566.41v13.88c0,2.186-.984,3.716-3.279,3.716a15.992,15.992,0,0,1-2.624-.219l.219-2.732h1.618c.634,0,.9-.284.9-.9V569.251H702.16V566.41Z" transform="translate(-634.139 -566.189)" fill="<?php echo $args['icons'] == 'white' ? '#ffffff' : '#212322' ?>" />
                                <path id="Path_27" data-name="Path 27" d="M747.225,566.41v13.115c0,2.841-1.531,4.59-4.045,4.59s-4.045-1.749-4.045-4.59V566.41h3.279v13.968c0,.721.241,1.115.766,1.115s.765-.394.765-1.115V566.41Z" transform="translate(-664.362 -566.189)" fill="<?php echo $args['icons'] == 'white' ? '#ffffff' : '#212322' ?>" />
                                <path id="Path_28" data-name="Path 28" d="M789.638,576.937a2.548,2.548,0,0,1,.131.984v1.618c0,.678.306,1.115.809,1.115.525,0,.831-.437.831-1.2,0-1.4-.918-2.688-1.88-3.956l-.634-.831c-1.486-1.946-2.1-3.235-2.1-5.159,0-2.513,1.508-4.263,3.979-4.263,2.514,0,3.891,1.749,3.891,4.525a4.266,4.266,0,0,0,.131,1.268v.218h-2.951a2.957,2.957,0,0,1-.131-.983v-1.465c0-.7-.328-1.049-.787-1.049-.481,0-.853.35-.853,1.224,0,1.29.677,2.208,1.639,3.432l.656.831c1.509,1.9,2.318,3.41,2.318,5.552,0,2.667-1.509,4.372-3.891,4.372-2.667,0-4.023-1.727-4.023-4.787a3.885,3.885,0,0,0-.131-1.224v-.219Z" transform="translate(-702.963 -565.242)" fill="<?php echo $args['icons'] == 'white' ? '#ffffff' : '#212322' ?>" />
                                <path id="Path_29" data-name="Path 29" d="M839.707,566.41v2.841H837.52V583.9h-3.279V569.251h-2.186V566.41Z" transform="translate(-739.863 -566.189)" fill="<?php echo $args['icons'] == 'white' ? '#ffffff' : '#212322' ?>" />
                                <rect id="Rectangle_707" data-name="Rectangle 707" width="3.279" height="17.487" transform="translate(100.798 0.218)" fill="<?php echo $args['icons'] == 'white' ? '#ffffff' : '#212322' ?>" />
                                <path id="Path_30" data-name="Path 30" d="M905.215,565.244c2.624,0,4.023,2.077,4.023,5.355a5.379,5.379,0,0,0,.109,1.2v.218h-3.279a3.574,3.574,0,0,1-.109-.983v-2.164c0-.612-.262-1.005-.787-1.005s-.852.393-.852,1.115v10.339c0,.721.328,1.115.852,1.115s.787-.393.787-1.005v-2.164a3.578,3.578,0,0,1,.109-.984h3.279v.219a4.932,4.932,0,0,0-.109,1.312c0,3.279-1.4,5.355-4.023,5.355-2.842,0-4.5-2.295-4.5-8.306V573.55c0-6.011,1.662-8.306,4.5-8.306" transform="translate(-795.648 -565.244)" fill="<?php echo $args['icons'] == 'white' ? '#ffffff' : '#212322' ?>" />
                                <path id="Path_31" data-name="Path 31" d="M957.506,566.41v2.841h-2.624v4.372h2.3v2.842h-2.3v4.59h2.624V583.9h-5.9V566.41Z" transform="translate(-836.998 -566.189)" fill="<?php echo $args['icons'] == 'white' ? '#ffffff' : '#212322' ?>" />
                            </g>
                    ...
                    <div id="headerSearch" class="header__search">
                        <div class="header__search-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 17.5 20.5">
                                <path id="Union_1" data-name="Union 1" d="M.489,20.16a1.423,1.423,0,0,1-.151-1.994L5.6,12.119A7.084,7.084,0,0,1,10.5,0a7.069,7.069,0,0,1,0,14.138,6.921,6.921,0,0,1-2.653-.526L2.463,20.006a1.391,1.391,0,0,1-1.974.154ZM4.9,7.07a5.6,5.6,0,1,0,5.6-5.656A5.634,5.634,0,0,0,4.9,7.07Z" fill="<?php echo $args['icons'] == 'white' ? '#ffffff' : '#212322' ?>" />
                            </svg>
                        </div>
                        <?php get_search_form() ?>
                    </div>
