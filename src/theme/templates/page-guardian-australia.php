...
/**
 * Template Name: Guardian Australia
 *
            ...
            <div class="donorfy-donate__forms">
                ...
                <form id="formOne">
                    ...
                    <div class="donorfy-donate__giving-text">
                        You’re giving AUD $<span id="textAmount"><?php echo $_GET[
                        	"Amount"
                        ]; ?></span> monthly
 	...
 	"Amount"
                ...
                <form id="CreditCardForm">
                    ...
                    <div class="donorfy-donate__summary-text">
                        Donation total: <b>AUD $<span id="donationTotalConfirm"><?php echo $_GET[
                        	"Amount"
                        ]; ?></span></b>
                        <br>
                    ...
                    <div class="donorfy-donate__buttons">
                        ...
                        <button id="submitButton" class="button button--spinner">Donate monthly</button>
                    </div>
                    ...
                    <input type="hidden" id="WidgetId" value="<?php if (
                    	...
                    	echo "18b4d6e0-eb52-ee11-a81c-000d3ab0df23";
                    } ?>" />
                    ...
                    <input type="hidden" id="type" value="Australia+Guardian" />
