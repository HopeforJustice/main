...
<main id="main" class="site-main homepage" role="main">
	...
	<div class="full-grid">
		...
		<div class="homepage-hero" style="background-image: url('<?php echo $thumbnail[0]; ?>');">
		</div>
		...
		<div class="homepage-hero__content">
			...
			<h1 class="font-canela homepage-hero__title">
				<?php the_field('title'); ?>
			</h1>
		...
		--  
		-->
		<div class="homepage-get-involved">
			<h2 class="homepage-get-involved__title font-canela">
				<?php the_field('grid_title'); ?>	
			</h2>
			<p class="homepage-get-involved__text">
				<?php the_field('grid_description'); ?>
			</p>
		</div>

		<div class="homepage-get-involved__grid get-involved__grid">
		...
		--  
		-->
		<div class="homepage-freedom-wall">
			<div style="background-image: url('<?php the_field('freedom_wall_image'); ?>');" class="homepage-freedom-wall__image"></div>
		</div> 
		...
		<div class="homepage-freedom-wall__info">
			...
			<div class="homepage-freedom-wall__button">
