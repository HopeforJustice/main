...
/**
 * Class AddStripeAccountApiKeysDto
...
class AddStripeAccountApiKeysDto {
	...
	public static function fromArray( $array ){
		...
		$self->type = 'manual';
		$self->formId = ! empty( $array['form_id'] ) ? absint( $array['form_id'] ) : 0;
		$self->accountSlug = give_stripe_get_unique_account_slug( give_stripe_get_all_accounts() );
	 ...
	 * @return array
	 */
	public function getStripeAccountDetails(){
		return [
			'type' => $this->type,
