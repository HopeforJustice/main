...
class Give_Recurring_Authorize_eCheck extends Give_Recurring_Gateway {
	...
	public function init() {
		...
		add_action( 'give_recurring_cancel_authorize_echeck_subscription', array( $this, 'cancel' ), 10, 2 );
	...
	public function cancel( $subscription, $valid ) {
		...
		return $this->cancel_authorize_net_echeck_subscription( $subscription->profile_id );
	}
